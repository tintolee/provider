      ...
      {layoutProps.offcanvas && (
        ...
        >
          <div className='topbar-item'>
            <div
              className={`btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto lg`}
            ...
            >
              ...
              <span className='symbol symbol-35'>
                <span className='symbol-label font-size-h5 font-weight-bold bg-white-o-30'>
                  {user.fullname[0]}
                </span>
              </span>
            </div>
